...
def test_alpha_frame_selection_shows_body_and_accessory_once() -> None:
    names = (
        ...
        accessory_frame_geom_name("alex", "idle", 0, "cap_simple_v1"),
        frame_geom_name("alex", "idle", 1, "body"),
        accessory_frame_geom_name("alex", "idle", 1, "cap_simple_v1"),
    )
    ...
    assert visible[accessory_frame_geom_name("alex", "idle", 1, "cap_simple_v1")]
